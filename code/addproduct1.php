...
$sql="insert into product2(customer_id,name,company_name,mrp,selling_price,description,img1,img2,img3,img4) values('$id','$product','$company','$mrp','$price','$des','$image1','$image2','$image3','$image4')";
