  ...
  <li><a align="right" href="addproduct.php">Post Ad</a>
	...
	<div class="search_container">
		...
		<div class="sub_categories_div">
			...
			<tr><td style="width:800px;background-color:#ec7063;font-size:30px;text-align:center;border-radius:10px;"> Properties 
				...
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<button onclick="myFunction()" style="height:90%;" class="w3-button w3-black">For Rent</button>
						<div id="Dd" style="width:100%;" class="w3-dropdown-content w3-bar-block w3-border">
							<a href="#" class="w3-bar-item w3-button">Appartments</a>
							<a href="#" class="w3-bar-item w3-button">House & Villas</a>
							<a href="#" class="w3-bar-item w3-button">plots</a>
							<a href="#" class="w3-bar-item w3-button">Shops & office</a>
							<a href="#" class="w3-bar-item w3-button">Farmhouse</a>
						</div>
					</div></td></tr>
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<button onclick="myFunction2()" class="w3-button w3-black">For Sale</button>
						<div id="Dd2" style="width:100%;" class="w3-dropdown-content w3-bar-block w3-border">
							<a href="#" class="w3-bar-item w3-button">Appartments</a>
							<a href="#" class="w3-bar-item w3-button">House & Villas</a>
							<a href="#" class="w3-bar-item w3-button">plots</a>
							<a href="#" class="w3-bar-item w3-button">Shops & office</a>
				...
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<button onclick="myFunction3()" class="w3-button w3-black">New Projects</button>
						<div id="Dd3" style="width:100%;" class="w3-dropdown-content w3-bar-block w3-border">
							<a href="#" class="w3-bar-item w3-button">Appartments</a>
							<a href="#" class="w3-bar-item w3-button">House & Villas</a>
							<a href="#" class="w3-bar-item w3-button">plots</a>
							<a href="#" class="w3-bar-item w3-button">Shops & office</a>
    ...
    if (x.className.indexOf("w3-show") == -1) {
		...
		<fieldset class="fieldset1">
			<legend class="fieldset_name_css"><img src="photos/property.png" height="100px" width="100px"></legend>
...
function showSlides(n) {
  ...
  dots[slideIndex-1].className += " active";
	...
	<td>  
	&nbsp <font color="black" size="5">name: <?php echo $row["title"]?></font> <br	> 
	&nbsp type: 	  <font color="black" size="5"> <?php echo $row["settype1"]?><br>
	&nbsp type: 	  <?php echo $row["settype2"] ?><br>
	&nbsp bedroom:    <?php echo $row["bedroom"] ?><br>
	&nbsp bathroom:   <?php echo $row["bathroom"] ?><br>
	&nbsp furnishing:  <?php echo $row["furnishing"] ?>
	&nbsp Construction:<?php echo $row["construction"] ?><br>
	&nbsp Carpet Area: <?php echo $row["carpet"] ?><br>
	&nbsp floor:       <?php echo $row["floor"] ?><br>
	&nbsp total floor: <?php echo $row["floor_no"] ?><br>
	...
	<tr>
	<td colspan="2"><font color="blue" size="6">&nbsp prize:- </font><font size="6"><?php echo $row["prize"]; ?>
