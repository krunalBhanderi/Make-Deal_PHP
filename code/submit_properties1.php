...
$carpet=$_POST["carpet"];
$total_floor=$_POST["total_floors"];
...
$sql="insert into properties(id,title,prize,settype1,settype2,bedroom,furnishing,construction,carpet,floor,floor_no,description,img1,img2,img3,img4) values('$id','$title','$price','$subtype1','$subtype2','$bedroom','$furnishing','$construction','$carpet','$total_floor','$floor_no','$description','$image1','$image2','$image3','$image4')";
