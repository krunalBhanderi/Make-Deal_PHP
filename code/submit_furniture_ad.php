	...
	<div class="main_content_deivision">
		<fieldset class="submit_ad_fieldset">
			<legend class="fieldset_name_css">Submit an Ad</legend>
				...
				<form action="submit_furniture1.php" method="post" enctype="multipart/form-data">
				...
				<tr><td class="tdcss1">Type<td class="tdcss2"><select name="type" class="inputcss2">
										<option>Sofa_&_Dining</option>
										<option>Beds_&_Wardrobes</option>
										<option>Homedecore_&_Garden</option>
										<option>Other_House_Hold_Items</option>
										<option>Kids_Furniture</option>
									</select></tr>
				<tr><td class="tdcss1">Description<td class="tdcss2"><input type="text" rows="5" cols="40"></textarea></tr>
				<tr>
					<td>
					</td>
					<td>
