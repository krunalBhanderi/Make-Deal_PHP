  ...
  <li><a align="right" href="addproduct.php">Post Ad</a>
	...
	<div class="search_container">
		...
		<div class="sub_categories_div">
			...
			<tr><td style="width:800px;background-color:#ec7063;font-size:30px;text-align:center;border-radius:10px;"> Bikes 
				...
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						...
						<div id="Dd" style="width:100%;" class="w3-dropdown-content w3-bar-block w3-border">
							<a href="#" class="w3-bar-item w3-button">Bajaj</a>
							<a href="#" class="w3-bar-item w3-button">Hero_Honda</a>
							<a href="#" class="w3-bar-item w3-button">Yamaha</a>
							<a href="#" class="w3-bar-item w3-button">Suzuki</a>
							<a href="#" class="w3-bar-item w3-button">Hero</a>
							<a href="#" class="w3-bar-item w3-button">Honda</a>
							<a href="#" class="w3-bar-item w3-button">Tvs</a>
							<a href="#" class="w3-bar-item w3-button">Ktm</a>
