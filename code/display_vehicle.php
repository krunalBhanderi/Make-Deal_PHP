  ...
  <li><a align="right" href="addproduct.php">Post Ad</a>
	...
	<div class="search_container">
		...
		<div class="sub_categories_div">
			...
			<tr><td style="width:800px;background-color:#ec7063;font-size:30px;text-align:center;border-radius:10px;"> cars 
				...
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<button onclick="myFunction()" style="height:90%;" class="w3-button w3-black">brand</button>
						<div id="Dd" style="width:100%;" class="w3-dropdown-content w3-bar-block w3-border">
							<a href="#" class="w3-bar-item w3-button">Maruti_Suzuki</a>
							<a href="#" class="w3-bar-item w3-button">Hyundai</a>
							<a href="#" class="w3-bar-item w3-button">Honda</a>
							<a href="#" class="w3-bar-item w3-button">Chevrolet</a>
							<a href="#" class="w3-bar-item w3-button">Valkswagen</a>
							<a href="#" class="w3-bar-item w3-button">Ford</a>
							<a href="#" class="w3-bar-item w3-button">Skoda</a>
							<a href="#" class="w3-bar-item w3-button">Toyota</a>
							<a href="#" class="w3-bar-item w3-button">Mitsubishi</a>
							<a href="#" class="w3-bar-item w3-button">Mahindra</a>
							<a href="#" class="w3-bar-item w3-button">Fiat</a>
							<a href="#" class="w3-bar-item w3-button">Nissan</a>
							<a href="#" class="w3-bar-item w3-button">Renault</a>
							<a href="#" class="w3-bar-item w3-button">Mercedes_Benz</a>
							<a href="#" class="w3-bar-item w3-button">BMW</a>
							<a href="#" class="w3-bar-item w3-button">Audi</a>
							<a href="#" class="w3-bar-item w3-button">Hindustan_Motors</a>
    ...
    if (x.className.indexOf("w3-show") == -1) {
		...
		<fieldset class="fieldset1">
			<legend class="fieldset_name_css"><img src="photos/car.png" height="100px" width="100px"></legend>
...
function showSlides(n) {
  ...
  dots[slideIndex-1].className += " active";
	...
	<td>  
	&nbsp <font color="black" size="6"> <?php echo $row["title"]?></font> <br	> 
	&nbsp comapny: 	  <font color="black" size="5"> <?php echo $row["company"]?><br>
	&nbsp model: 	  <?php echo $row["model"] ?><br>
	&nbsp year:    <?php echo $row["year"] ?><br>
	&nbsp type:   <?php echo $row["fuel"] ?><br>
	&nbsp km:  <?php echo $row["km"] ?>
	<br>
