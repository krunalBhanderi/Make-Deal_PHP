...
<html>
<body align="center">
<a href="display_properties.php?pid=<?php echo $row["product_id"];?>">
<table  height="10" align="center">
	...
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["title"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["prize"] ?> </td></tr>
	<hr width="800">
</table></a>
</body>
</html>
...
<html>
<body align="center">
<a href="display_pet.php?pid=<?php echo $row["product_id"];?>">
<table  height="10" align="center">
	<tr width="700">
	<td margin="left" rowspan="7"><img src="<?php echo 'uploads/'.$row["img1"]; ?>" height="100" width="200" style="margin-right:-0"></td>
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["name"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["price"] ?> </td></tr>
	<hr width="800">
</table></a>
</body>
</html>
...
<table  height="10" align="center">
	<tr width="700">
	<td margin="left" rowspan="7"><img src="<?php echo 'uploads/'.$row["img1"]; ?>" height="100" width="200" style="margin-right:-0"></td>
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["title"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["price"] ?> </td></tr>
	<hr width="800">
</table></a>
</body>
</html>
...
<html>
<body align="center">
<a href="display_bike.php?pid=<?php echo $row["product_id"];?>">
<table  height="10" align="center">
	<tr width="700">
	<td margin="left" rowspan="7"><img src="<?php echo 'uploads/'.$row["img1"]; ?>" height="100" width="200" style="margin-right:-0"></td>
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["name"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["prize"] ?> </td></tr>
	<hr width="800">
</table></a>
</body>
</html>
...
<html>
<body align="center">
<a href="display_vehicle.php?pid=<?php echo $row["product_id"];?>">
<table  height="10" align="center">
	<tr width="700">
	<td margin="left" rowspan="7"><img src="<?php echo 'uploads/'.$row["img1"]; ?>" height="100" width="200" style="margin-right:-0"></td>
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["name"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["prize"] ?> </td></tr>
...
<html>
<body align="center">
<a href="display_electronics.php?pid=<?php echo $row["product_id"];?>">
<table  height="10" align="center">
	<tr width="700">
	<td margin="left" rowspan="7"><img src="<?php echo 'uploads/'.$row["img1"]; ?>" height="100" width="200" style="margin-right:-0"></td>
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["name"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["prize"] ?> </td></tr>
...
<html>
<body align="center">
<a href="display_sport.php?pid=<?php echo $row["product_id"];?>">
<table  height="10" align="center">
	<tr width="700">
	<td margin="left" rowspan="7"><img src="<?php echo 'uploads/'.$row["img1"]; ?>" height="100" width="200" style="margin-right:-0"></td>
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["name"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["prize"] ?> </td></tr>
...
<html>
<body align="center">
<a href="display_fashion.php?pid=<?php echo $row["product_id"];?>">
<table  height="10" align="center">
	<tr width="700">
	<td margin="left" rowspan="7"><img src="<?php echo 'uploads/'.$row["img1"]; ?>" height="100" width="200" style="margin-right:-0"></td>
	<td>&nbsp &nbsp &nbsp <font color="blue" size="20"> <?php echo $row["name"]?></font> <br>nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <font size="15" >RS: <?php echo  $row["prize"] ?> </td></tr>
