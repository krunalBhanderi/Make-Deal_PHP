...
$sql="insert into vehicle(id,title,price,company,model,year,fuel,km,description,img1,img2,img3,img4) values('$id','$title','$price','$comapny','$model','$year','$fuel','$km','$description','$image1','$image2','$image3','$image4')";
