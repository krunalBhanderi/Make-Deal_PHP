  ...
  <li><a align="right" href="addproduct.php">Post Ad</a>
	...
	<div class="search_container">
		...
		<div class="sub_categories_div">
			...
			<tr><td style="width:800px;background-color:#ec7063;font-size:30px;text-align:center;border-radius:10px;"> Fashion
				...
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<a href="#" class="w3-bar-item w3-button"><button style="height:90%;" class="w3-button w3-black">men</button>
	
					</div></td></tr>
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<a href="#" class="w3-bar-item w3-button"><button class="w3-button w3-black">Women</button>
					</div></tr>
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<a href="#" class="w3-bar-item w3-button"><button class="w3-button w3-black">Kids</button>
					</div></td></tr>
