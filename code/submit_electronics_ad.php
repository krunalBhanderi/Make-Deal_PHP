	...
	<div class="main_content_deivision">
		<fieldset class="submit_ad_fieldset">
			<legend class="fieldset_name_css">Submit an Ad</legend>
				...
				<form action="submit_electroincs1.php" method="post" enctype="multipart/form-data">
				...
				<tr><td class="tdcss1">Type<td class="tdcss2"><select name="type" class="inputcss2">
										<option>Computers_&_Laptops</option>
										<option>Tvs</option>
										<option>Harddisks_printers_monitors</option>
										<option>Acs</option>
										<option>Washing_Machines</option>
										<option>fridges</option>
										<option>Computer_accessories</option>
										<option>Cameras_&_Lenses</option>
										<option>Kitchen_&_otherappliances</option>
										<option>Games_&_Entertainment</option>

									</select></tr>
				<tr><td class="tdcss1">Description<td class="tdcss2"><input type="text" rows="5" cols="40"></tr>
				<tr>
					<td>
					</td>
					<td>
...
</tr>			<tr height="100px"><td style="border-top:1px solid grey;" class="tdcss1" colspan="2" align="right"><input style="height:60px; width:150px; background-color:#ff9933; margin-right: 10px; font-size:20px; color:white;" type="submit" name="submit" value="submit"></tr>	
				</table>					
				</div>
		</fieldset>
