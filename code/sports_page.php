  ...
  <li><a align="right" href="addproduct.php">Post Ad</a>
	...
	<div class="search_container">
		...
		<div class="sub_categories_div">
			...
			<tr><td style="width:800px;background-color:#ec7063;font-size:30px;text-align:center;border-radius:10px;"> Sports & Hobbies 
				...
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<a href="#" class="w3-bar-item w3-button"><button style="height:90%;" class="w3-button w3-black">Books</button>
	
					</div></td></tr>
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<a href="#" class="w3-bar-item w3-button"><button class="w3-button w3-black">Sports_Equipments</button>
					</div></tr>
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<a href="#" class="w3-bar-item w3-button"><button class="w3-button w3-black">Musical_Instruments</button>
					</div></td></tr>
				<tr>
					<td colspan="2" class="sub_categories_table_tr" align="center"><div class="w3-dropdown-click">
						<a href="#" class="w3-bar-item w3-button"><button class="w3-button w3-black">Others</button>
					</div></td></tr>
		...
		<script>
			...
			<legend class="fieldset_name_css"><img src="photos/Hobby.png" height="100px" width="100px"></legend>
