	...
	<div class="main_content_deivision">
		<fieldset class="submit_ad_fieldset">
			<legend class="fieldset_name_css">Submit an Ad</legend>
				...
				<form action="submit_bikes1.php" method="post" enctype="multipart/form-data">
				<table class="submit_ad_table"  align="center">
				<tr><td class="tdcss1">Title*<td class="tdcss2"><input class="inputcss" type="text" name="ad_title" required="*"></tr>
